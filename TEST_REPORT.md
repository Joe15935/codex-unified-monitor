...
- Native v0.2.0 startup/export UI: NOT_TESTED pending exit of the old v0.1.0 process. The previous process remained running after cooperative UI quit attempts. The automation runtime refused forced termination because it could not establish process ownership. No alternate termination mechanism was used. The new bundle is installed on disk, while old-process exit is a separate acceptance step.
